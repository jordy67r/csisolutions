...
class EnquiriesControllerTest < ActionController::TestCase
  ...
  test "should create enquiry" do
    assert_difference('Enquiry.count') do
      post :create, enquiry: { body: @enquiry.body, company: @enquiry.company, email: @enquiry.email, name: @enquiry.name, phone: @enquiry.phone }
    end
  ...
  test "should update enquiry" do
    patch :update, id: @enquiry, enquiry: { body: @enquiry.body, company: @enquiry.company, email: @enquiry.email, name: @enquiry.name, phone: @enquiry.phone }
    assert_redirected_to enquiry_path(assigns(:enquiry))
  end
